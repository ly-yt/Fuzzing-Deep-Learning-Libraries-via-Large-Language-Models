...
class InfillingModel:
    def __init__(self, model_name="facebook/incoder-1B", cuda=True, device=None, tokenizer=None, half=True, model=None):
        ...
        if model is None:
            print("loading model")
            model = AutoModelForCausalLM.from_pretrained("/Users/lyt/vscode/llm/incoder_1B", **kwargs) #原版是model_name
        if tokenizer is None:
            print("loading tokenizer")
            tokenizer = AutoTokenizer.from_pretrained('/Users/lyt/vscode/llm/incoder_1B') #原版是model_name
